    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                String js = "(function(){" +
                        "var files=['map_countries.js','map_admin1.js','map_cities.js','map_yemen_admin.js','phase2-map.js','phase9-vector-camera-ui.js','phase10-yemen-tutorial.js'];" +
                        "function next(i){if(i>=files.length)return;var s=document.createElement('script');" +
                        "s.src=files[i]+'?v=10';s.onload=function(){next(i+1)};" +
