    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                String js = "(function(){" +
                        "var files=['map_countries.js','map_admin1.js','map_cities.js','phase2-map.js','phase7-rtl-map-fix.js','phase6-camera.js'];" +
                        "function next(i){if(i>=files.length)return;var s=document.createElement('script');" +
                        "s.src=files[i]+'?v=7';s.onload=function(){next(i+1)};" +
